...
# Note: Some workshops have MULTIPLE orgs in org_ids!
talleres = [
...
# Note: Beneficiaries are enrolled in MULTIPLE workshops!
beneficiarios = [
    {
        'id': 1, 'dni': '28.456.789', 'nombre': 'Carlos Alberto Gómez', 'localizacion': 'Rosario, Santa Fe', 'direccion': 'San Martín 3200, Rosario',
        'talleres': [1, 2], 'fechaInicio': '2022-05-12', 'inicioBeca': '2022-05-12', 'presupuestoBeca': 120000, 'ultimoRegistro': '2024-03-01', 'estado': 'Activo', 'alerta': False,
    ...
    },
    {
        ...
        'talleres': [3, 10], 'fechaInicio': '2021-08-20', 'inicioBeca': '2021-08-20', 'presupuestoBeca': 120000, 'ultimoRegistro': '2023-11-15', 'estado': 'Sin seguimiento', 'alerta': True,
    ...
    },
    {
        ...
        'talleres': [4, 5, 6], 'fechaInicio': '2023-01-10', 'inicioBeca': '2023-01-10', 'presupuestoBeca': 150000, 'ultimoRegistro': '2024-03-25', 'estado': 'Activo', 'alerta': False,
    ...
    },
    {
        ...
        'talleres': [7, 8], 'fechaInicio': '2023-02-05', 'inicioBeca': '2023-02-05', 'presupuestoBeca': 120000, 'ultimoRegistro': '2024-03-20', 'estado': 'Activo', 'alerta': False,
    ...
    },
    {
        ...
        'talleres': [1, 11], 'fechaInicio': '2023-09-28', 'inicioBeca': '2023-09-28', 'presupuestoBeca': 150000, 'ultimoRegistro': '2023-09-10', 'estado': 'Suspendido', 'alerta': True,
    ...
    },
    {
        ...
        'talleres': [3], 'fechaInicio': '2022-11-05', 'inicioBeca': '2022-11-05', 'presupuestoBeca': 120000, 'ultimoRegistro': '2024-04-10', 'estado': 'Activo', 'alerta': False,
        'contacto': 'anapaula@gmail.com', 'telefono': '342-888999'
    },
    {
        'id': 7, 'dni': '36.777.888', 'nombre': 'Esteban Gabriel Rossi', 'localizacion': 'Venado Tuerto, Santa Fe', 'direccion': 'Chaco 450, Venado Tuerto',
        'talleres': [2, 9], 'fechaInicio': '2023-04-12', 'inicioBeca': '2023-04-12', 'presupuestoBeca': 140000, 'ultimoRegistro': '2024-03-18', 'estado': 'Activo', 'alerta': False,
        'contacto': 'erossi@gmail.com', 'telefono': '3462-555123'
    },
    {
        'id': 8, 'dni': '39.444.111', 'nombre': 'Florencia Antonella Ríos', 'localizacion': 'Santo Tomé, Santa Fe', 'direccion': '7 de Marzo 1800, Santo Tomé',
        'talleres': [4, 11], 'fechaInicio': '2023-06-01', 'inicioBeca': '2023-06-01', 'presupuestoBeca': 130000, 'ultimoRegistro': '2024-04-02', 'estado': 'Activo', 'alerta': False,
        'contacto': 'flor.rios@hotmail.com', 'telefono': '342-666333'
    },
    {
        'id': 9, 'dni': '29.888.333', 'nombre': 'Gonzalo Javier Peralta', 'localizacion': 'Sunchales, Santa Fe', 'direccion': 'Alem 340, Sunchales',
        'talleres': [12, 1], 'fechaInicio': '2022-01-15', 'inicioBeca': '2022-01-15', 'presupuestoBeca': 160000, 'ultimoRegistro': '2024-03-30', 'estado': 'Activo', 'alerta': False,
        'contacto': 'gonza.peralta@gmail.com', 'telefono': '3493-456123'
    },
    {
        'id': 10, 'dni': '34.222.999', 'nombre': 'Valeria Soledad Domínguez', 'localizacion': 'El Trébol, Santa Fe', 'direccion': 'Córdoba 120, El Trébol',
        'talleres': [8], 'fechaInicio': '2023-07-20', 'inicioBeca': '2023-07-20', 'presupuestoBeca': 120000, 'ultimoRegistro': '2024-01-10', 'estado': 'Sin seguimiento', 'alerta': True,
        'contacto': 'valedominguez@gmail.com', 'telefono': '3401-444777'
    }
]
...
alertas = [
    ...
    {'id': 2, 'tipo': 'convenio_vencimiento', 'mensaje': 'Convenio "Subsidio Hábitat" de Vecinos al Frente próximo a vencer.', 'fecha': 'hace 5 horas', 'prioridad': 'critica'},
    {'id': 3, 'tipo': 'oportunidad', 'mensaje': 'Nuevo programa "Santa Fe Más" disponible para convocatorias industriales.', 'fecha': 'hace 1 día', 'prioridad': 'media'},
    {'id': 4, 'tipo': 'sin_actualizacion', 'mensaje': 'Beneficiario Valeria Domínguez (34.222.999) requiere informe de asistencia.', 'fecha': 'hace 1 día', 'prioridad': 'alta'}
]

actividadReciente = [
    {'id': 1, 'usuario': 'Tamara G.', 'accion': 'importó 15 beneficiarios', 'modulo': 'Beneficiarios', 'fecha': 'hace 10 min', 'avatar': 'TG'},
    {'id': 2, 'usuario': 'Facundo M.', 'accion': 'aprobó el convenio #conv-8', 'modulo': 'Convenios', 'fecha': 'hace 1 hora', 'avatar': 'FM'},
    {'id': 3, 'usuario': 'Gonzalo R.', 'accion': 'asignó 3 talleres a Santa Fe Produce', 'modulo': 'Talleres', 'fecha': 'hace 3 horas', 'avatar': 'GR'}
]
...
with open('src/data/mockData.js', 'w', encoding='utf-8') as f:
    f.write(out)
print('Generated rich dynamic Santa Fe dataset in mockData.js')
