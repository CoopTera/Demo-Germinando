    ...
    <>
      ...
      >
        <div className="flex flex-col min-h-0">
          {/* Brand Header */}
          <div
            className="h-24 flex items-center border-b border-white/10 shrink-0 overflow-hidden"
                  ...
                  {section.items.map((item) => {
                    ...
                    return (
                      <NavLink
                        ...
                        className={({ isActive }) =>
                          \`relative flex items-center text-[15px] transition-colors duration-150 whitespace-nowrap overflow-hidden \${
        ...
        <div className="mt-auto overflow-hidden">
          <div style={{ paddingTop: '16px', paddingBottom: '16px', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
            <NavLink
              ...
              className={({ isActive }) =>
                \`relative text-[15px] transition-colors duration-150 whitespace-nowrap overflow-hidden \${
                  isActive ? 'text-[#6B1330] font-bold' : 'text-white/80 hover:bg-white/5 hover:text-white font-medium'
                }\`
              }
            >
          ...
          <AnimatePresence mode="wait">
            {!collapsed && (
              <motion.div
                ...
                className="pb-6 pt-2 text-center shrink-0 whitespace-nowrap"
              >
...
console.log('Sidebar expanding animation smooth fix applied OK');
