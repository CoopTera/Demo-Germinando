    ...
    <>
      ...
      >
        <div className="flex flex-col min-h-0">
          ...
          {/* Navigation Links */}
          <nav className="overflow-y-auto overflow-x-visible" style={{ paddingTop: '24px', paddingBottom: '24px' }}>
        ...
        <div className="mt-auto">
          <div style={{ paddingTop: '12px', paddingBottom: '12px', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
            <NavLink
              to="/perfil"
              onClick={onClose}
...
console.log('Fixed item height to lock vertical positions perfectly!');
